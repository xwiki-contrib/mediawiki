...
import org.xwiki.contrib.mediawiki.syntax.mylyn.internal.input.MylynMediaWikiSyntaxInputFilterStreamFactory;
 ...
 */
@Component
@Named(MylynMediaWikiStreamParser.SYNTAX_STRING)
@Singleton
public class MylynMediaWikiStreamParser implements StreamParser
{
    /**
     * The syntax with version.
     */
    public static final Syntax SYNTAX = new Syntax(MediaWiki.SYNTAX_TYPE, "2.0");

    /**
     * The String version of the syntax.
     */
    public static final String SYNTAX_STRING = "mediawiki/2.0";
